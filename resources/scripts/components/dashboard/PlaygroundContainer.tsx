...
const Section = ({ title, code, children }: { title: string; code?: string; children: React.ReactNode }) => (
    <section css={tw`mb-12`}>
        <h3 css={tw`text-xl font-header mb-4 border-b border-neutral-700 pb-2 text-neutral-100`}>
            {title}
        </h3>
        <div css={tw`grid grid-cols-1 gap-6`}>
            ...
            {code && (
                <div css={tw`bg-black/50 rounded-lg p-4 border border-neutral-800`}>
                    <p css={tw`text-2xs uppercase text-neutral-500 font-bold mb-2`}>Usage Example</p>
			...
			<div css={tw`max-w-5xl mx-auto`}>
				<header css={tw`mb-10`}>
					...
					<p css={tw`text-neutral-400`}>
						A comprehensive documentation and playground for Pterodactyl components.
					</p>
				</header>
                ...
                >
					<div css={tw`grid grid-cols-1 md:grid-cols-2 gap-8`}>
                        <div css={tw`space-y-4`}>
                            <p css={tw`text-xs uppercase text-neutral-500 font-bold mb-2`}>Standard Variants</p>
                        ...
                        <div css={tw`space-y-4`}>
                            <p css={tw`text-xs uppercase text-neutral-500 font-bold mb-2`}>Sizes & States</p>
                ...
                <Section title={"Lucide Icons Showcase"} code={`import { LayoutDashboard, Server, Cpu } from 'lucide-react';\n\n<LayoutDashboard size={20} />`}>
                    <div css={tw`grid grid-cols-4 md:grid-cols-8 gap-4 bg-neutral-800 p-6 rounded-lg border border-neutral-700`}>
                ...
                >
					<div css={tw`bg-neutral-800 p-6 rounded-lg border border-neutral-700 max-w-sm`}>
                ...
                >
					<div css={tw`flex flex-wrap gap-4`}>
						...
						<Button.Danger onClick={() => setConfirmVisible(true)}>Open Confirmation</Button.Danger>
					</div>
                ...
                >
                    <div css={tw`bg-neutral-800 p-6 rounded-lg border border-neutral-700 max-w-lg`}>
				...
				<Section title={"Code Typography"} code={`<Code>npm install</Code>\n<Code dark>git push</Code>`}>
					<div css={tw`p-4 bg-neutral-900 rounded border border-neutral-700 max-w-lg`}>
                        <p css={tw`text-neutral-200`}>
                            Install via <Code>apt install</Code> or use <Code dark>docker compose</Code>.
                        </p>
                    </div>
				</Section>
			</div>
